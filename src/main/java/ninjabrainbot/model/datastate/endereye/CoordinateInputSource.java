...
import ninjabrainbot.model.input.IBuriedTreasureInputSource;
 ...
 */
public class CoordinateInputSource implements IPlayerPositionInputSource, IFossilInputSource, IBuriedTreasureInputSource, IDisposable {
	...
	private final ObservableField<BuriedTreasure> whenNewBuriedTreasureInputted;
	...
	public CoordinateInputSource(IClipboardProvider clipboardProvider) {
		...
		whenNewBuriedTreasureInputted = new ObservableField<>(null, true);
	...
	private void parseF3C(String f3c) {
		...
		final BuriedTreasure bt = BuriedTreasure.parseF3I(f3c);
		if (bt != null) {
			whenNewBuriedTreasureInputted.setAndAlwaysNotifySubscribers(bt);
		}
	...
	public ISubscribable<BuriedTreasure> whenNewBuriedTreasureInputted() {
		return whenNewBuriedTreasureInputted;
	}
